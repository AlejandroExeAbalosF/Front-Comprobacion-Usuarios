                 ...
                 return (
                    <div key={name} className="relative z-0  mb-6 group ">
                      ...
                      <label
                        ...
                        className="peer-focus:text-sm  absolute text-[13px]  duration-300 transform -translate-y-6 scale-75 top-[13px]  origin-[0] peer-focus:start-3 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-[6px] peer-focus:scale-75 peer-focus:-translate-y-6 bg-white left-3 px-1 pointer-events-none"
                      >
                        {placeholder}
                      </label>
                    </div>
